...
public class MainService extends IntentService {
    private static final String ACTION_CHECK_PATCH_UPDATE = "com.easyder.wrapper.service.action.ACTION_CHECK_PATCH_UPDATE";
    private static final String ACTION_CHECK_APK_UPDATE = "com.easyder.wrapper.service.action.ACTION_CHECK_APK_UPDATE";
