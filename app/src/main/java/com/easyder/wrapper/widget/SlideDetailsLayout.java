...
public class SlideDetailsLayout extends ViewGroup {
    ...
    public interface OnSlideDetailsListener {
         ...
         */
        void onStatueChanged(Status status);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            LogUtils.d("top: " + top + ", bottom: " + bottom);
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (changed) {
                    ...
                    if (null != mOnSlideDetailsListener) {
                        mOnSlideDetailsListener.onStatueChanged(mStatus);
                    }
                }
            }
        });
    ...
    public interface ScrollViewContainerInterface {
        void SlideUpper();
