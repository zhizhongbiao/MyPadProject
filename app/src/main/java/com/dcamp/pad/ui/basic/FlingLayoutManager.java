 ...
 *  实现滑动切换的效果
 */
public class FlingLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    private static final String TAG = "FlingLayoutManager";
    ...
    public FlingLayoutManager(int orientation) {
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == VERTICAL) {
            return new FlingLayoutManager.LayoutParams(
    ...
    /**
     * Layout the item view witch position specified by {@link FlingLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link FlingLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == FlingLayoutManager.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == FlingLayoutManager.HORIZONTAL) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(FlingLayoutManager layoutManager, View item, float fraction);
    }
    ...
    /**
     * Implement to support {@link FlingLayoutManager#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)}
     */
