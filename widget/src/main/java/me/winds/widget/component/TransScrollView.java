...
public class TransScrollView extends ScrollView {
    ...
    public void setTransView(View transView) {
        setTransView(transView, getResources().getColor(R.color.colorPrimary), DensityUtils.dp2px(getContext(), DFT_TRANSSTARTY), DensityUtils.dp2px(getContext(), DFT_TRANSENDY));
    }
