...
public final class TransActionBar extends LinearLayout {
    ...
    public TransActionBar(Context context) {
        this(context, null);
    }

    public TransActionBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TransActionBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    public void setData(String strTitle, int resIdLeft, String strLeft, int resIdRight, String strRight, final ActionBarClickListener listener) {
    public void setData(String strTitle, int resIdLeft, String strLeft, int resIdRight, String strRight) {
        if (!TextUtils.isEmpty(strTitle)) {
            tvTitle.setText(strTitle);
        } else {
            tvTitle.setVisibility(View.GONE);
